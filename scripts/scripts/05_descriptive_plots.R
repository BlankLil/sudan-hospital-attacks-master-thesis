...
#possible plot to show thresholds
...
# plot weekly series + threshold + escalation marking
...
# project to same CRS as our map
...
# with grey dots for NoInformations ----
